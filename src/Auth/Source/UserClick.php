...
namespace SimpleSAML\Module\profileauth\Auth\Source;
...
class UserClick extends Auth\Source
{
     ...
     */
    public const STAGEID = '\SimpleSAML\Module\profileauth\Auth\UserClick.state';

    /**
     * The key of the AuthId field in the state.
     */
    public const AUTHID = '\SimpleSAML\Module\profileauth\Auth\UserClick.AuthId';
    ...
    public function __construct(array $info, array $config)
    {
        ...
        if (array_key_exists('users', $config)) {
            ...
            Logger::warning("Module profileauth:UserClick misconfigured." .
    ...
    public function authenticate(array &$state): void
    {
         ...
         */
        $url = Module::getModuleURL('profileauth/login');
        $params = ['AuthState' => $id];
     ...
     *
     * This function is used by the login form (profileauth/login) when the user
    ...
    public static function handleLogin(string $authStateId, string $id): void
    {
        ...
        /** @var \SimpleSAML\Module\profileauth\Auth\Source\UserClick|null $source */
